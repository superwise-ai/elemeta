...
@pytest.mark.parametrize(
    ...
    [
        ("non-toxic sentence", "Elemeta is amazing", 0.0, 0.3),
...
def test_sentiment_analysis(name, text, min_toxicity_threshold, max_toxicity_threshold):
    ...
    assert (
        sentiment <= max_toxicity_threshold
