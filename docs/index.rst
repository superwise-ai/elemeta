...
To quickly try Elemeta please use our `quickstart colab <https://colab.research.google.com/github/superwise-ai/elemeta/blob/main/docs/notebooks/quick_started.ipynb>`_ or go to our `getting started section <https://docs.elemeta.ai/getting_started.html>`_
